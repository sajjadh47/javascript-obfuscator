 ...
 */
if ( ! class_exists( 'Javascript_Obfuscator_Settings_API' ) ):

class Javascript_Obfuscator_Settings_API
{
	/**
	...
	function _style_fix()
	{
		...
		<?php
			...
			<style type="text/css" media="screen">
				div#jsobfuscate_basic_settings h2 {display: none;}
			</style>
		<?php
	}
}
